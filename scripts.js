function initCanvas(){
    ...
    enemiespic1.src = 'imagenes/enemigo1.png'; //Enemigo 1
    enemiespic2.src = 'imagenes/enemigo2.png'; //Enemigo 2

    var cW = ctx.canvas.width; //700PX}
    var cH = ctx.canvas.heigth; //600PX
    ...
    var enemies = [
                    //Primer grupo de naves enemigas
                    ...
                    //segundo grupo de naves enemigas
    ...
    var renderEnemies = function(enemyList){
        for( var i=0; i<enemyList.length; i++){
            ...
            //Detecta colisión  de naves enemigas con nave aliada
    ...
    function Launcher(){
        ...
        // Función para detectar impacto de misil en la nave enemiga
    ...
    document.addEventListener('keyup', function(event){
        if(event.keyCode == 37){ // 37= Tecla izquierda
            launcher.x += 0;
            launcher.direccion = '';            
        }
    });
